...
`;
  ...
  var IconLayer = class extends import_core7.Layer {
    getShaders() {
      return super.getShaders({ vs: icon_layer_vertex_glsl_default, fs: icon_layer_fragment_glsl_default, modules: [import_core7.project32, import_core7.picking, iconUniforms] });
    }
    initializeState() {
      this.state = {
...
`;
  ...
  var LineLayer = class extends import_core8.Layer {
    ...
    getShaders() {
      return super.getShaders({ vs: line_layer_vertex_glsl_default, fs: line_layer_fragment_glsl_default, modules: [import_core8.project32, import_core8.picking, lineUniforms] });
    }
    // This layer has its own wrapLongitude logic
    get wrapLongitude() {
      return false;
  ...
  var import_core9 = __toESM(require_core3(), 1);
...
`
  ...
  function getLightSourceUniforms({ ambientLight, pointLights = [], directionalLights = [] }) {
    ...
    if (currentLight > MAX_LIGHTS) {
      import_core9.log.warn("MAX_LIGHTS exceeded")();
    }
...
`;
  ...
  var PointCloudLayer = class extends import_core10.Layer {
    getShaders() {
      return super.getShaders({
        vs: point_cloud_layer_vertex_glsl_default,
        fs: point_cloud_layer_fragment_glsl_default,
        modules: [import_core10.project32, gouraudMaterial, import_core10.picking, pointCloudUniforms]
      });
    }
    initializeState() {
  ...
  var ScatterplotLayer = class extends import_core11.Layer {
    getShaders() {
      return super.getShaders({
        ...
        modules: [import_core11.project32, import_core11.picking, scatterplotUniforms]
      });
    }
    initializeState() {
      this.getAttributeManager().addInstanced({
  ...
  var ColumnLayer = class extends import_core13.Layer {
    getShaders() {
      ...
      return super.getShaders({
        ...
        defines,
        modules: [import_core13.project32, flatShading ? phongMaterial : gouraudMaterial, import_core13.picking, columnUniforms]
      });
    }
    /**
  ...
  var SolidPolygonLayer = class extends import_core18.Layer {
    getShaders(type) {
      return super.getShaders({
        ...
        modules: [import_core18.project32, gouraudMaterial, import_core18.picking, solidPolygonUniforms]
      });
    }
    get wrapLongitude() {
      return false;
    ...
    initializeState() {
      ...
      if (viewport.isGeospatial && coordinateSystem === import_core18.COORDINATE_SYSTEM.DEFAULT) {
        coordinateSystem = import_core18.COORDINATE_SYSTEM.LNGLAT;
      }
      let preproject;
      if (coordinateSystem === import_core18.COORDINATE_SYSTEM.LNGLAT) {
        if (_full3d) {
...
`;
  ...
  var import_engine15 = __toESM(require_engine(), 1);
  var import_engine16 = __toESM(require_engine(), 1);
...
`;
  ...
  var TextBackgroundLayer = class extends import_core23.Layer {
    getShaders() {
      return super.getShaders({ vs: text_background_layer_vertex_glsl_default, fs: text_background_layer_fragment_glsl_default, modules: [import_core23.project32, import_core23.picking, textBackgroundUniforms] });
    }
    initializeState() {
      this.getAttributeManager().addInstanced({
        instancePositions: {
  ...
  var TextLayer = class extends import_core24.CompositeLayer {
    ...
    initializeState() {
      ...
      if (this.props.maxWidth > 0) {
        import_core24.log.warn("v8.9 breaking change: TextLayer maxWidth is now relative to text size")();
      }
    }
